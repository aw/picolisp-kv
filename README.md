...
# Requirements
  ...
  * PicoLisp 32-bit `v3.1.11` to `v20.5.26`
  * PicoLisp 64-bit `v17.12` to `v20.5.26`
...
**Client**
  ...
  5. Identify your client with `(kv-identify "key1" "value2" "key2" "value3")`
...
## Technical notes
  ...
  * Passwords are hashed using a very simple and collision-prone hashing function. It is not cryptographically secure or used for that purpose. If using this library over a network, please use [stunnel](https://www.stunnel.org/) or [hitch](https://github.com/varnish/hitch) as a TLS proxy between the client and server.
